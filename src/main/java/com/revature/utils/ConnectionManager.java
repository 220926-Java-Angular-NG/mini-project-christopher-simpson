...
public class ConnectionManager {
    ...
    we can reference that one connection that we created
    ...
    //2 - we need to check and see if the connection was already made
     ...
     because we want to protect our credentials we will add them to a jdbc.properties file
